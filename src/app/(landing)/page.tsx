...
export async function generateMetadata(): Promise<Metadata> {
  ...
  }. Having experience as a student, soldier and finally software developer I've had the opportunity to learn a lot in different roles. Feel free to take a look at my past jobs.
    ${experiencesConfig
      .map((exp) => {
